# Android website blocker that never phones home (`android-site-blocker-private`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://android-site-blocker-private.sociobot.in`. Artifact class: `android`.
